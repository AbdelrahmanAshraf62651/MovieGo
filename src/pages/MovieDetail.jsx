...
function MovieDetail() {
    ...
    return (
        <div className="movie-detail mt-5 relative h-[calc(100vh-150px)] text-white p-6 md:p-12">
            <img
            ...
            <div className="absolute top-5 right-5 bg-[#fff0] p-3 rounded-full hover:brightness-150 transition duration-100 z-10">
                <button onClick={handleFavClick}>
                    <FontAwesomeIcon
                        ...
                        className={`w-6 h-6 hover:scale-120 transition duration-150 cursor-pointer ${
            ...
            <div className="relative max-w-2xl h-[100%] flex flex-col justify-center gap-3">
            ...
            <div className="flex gap-2 mt-2 flex-wrap absolute bottom-10">
