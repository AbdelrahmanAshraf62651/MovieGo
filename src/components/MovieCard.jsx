...
function MovieCard({ movie }) {
    ...
    return (
        <Link ref={ref} to={`/${mediaType}/${movie.id}`} className={`movie-card flex flex-col hover:brightness-80 transition duration-200 text-white rounded-sm bg-gray-950 h-[100%] ${visible ? "fade-up" : ""}`}>
